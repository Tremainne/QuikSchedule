...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Initialize Facebook Login + Firebase Connection
        ...
        //End Facebook Login + Firebase Connection
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(this)
                .enableAutoManage(MainActivity.this, GoogleConnectionFailedListener)
                .addApi(Auth.GOOGLE_SIGN_IN_API, gso)
                .build();

        GoogleConnectionFailedListener = new GoogleApiClient.OnConnectionFailedListener() {
            @Override
            public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
                //TODO
                Log.d(TAG, "google:onConnectionFailed " + connectionResult.toString());
            }
        };
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            //Status of log in, add temporary button
            //mStatusTextView.setText(getString(R.string.signed_in_fmt, acct.getDisplayName()));

            //Create manual refresh method with boolean parameter
            //updateUI(true);
        } else {
